...
public class TreeADT {
    ...
    */
    ...
    public boolean Delete(int sValue) {
        boolean result;
    ...
    private NodeType FindNode(int sValue, NodeType aRoot) {
        NodeType result;
        NodeType parent;
    ...
    public ElementType Retrieve(int sValue) {
        ElementType result;
    ...
    private ElementType RetrieveNode(int sValue, NodeType aRoot) {
        ElementType result;
